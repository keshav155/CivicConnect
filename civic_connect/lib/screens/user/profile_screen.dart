...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Future uploadImage(String selection) async {
      //used to get image from camera and gallery
      File _imageFile;
      if (selection == "Camera") {
                          ...
                          children: <Widget>[
                                ...
                                child: ClipRRect(
                                    ...
                                    child: FadeInImage(
                                      ...
                                      placeholder: AssetImage(
                                          "assets/giphy.gif"),
                                      image: NetworkImage(
                                          userData['ImageURL']),) //Where the user image value is used
                                )),
                            ...
                            FractionalTranslation(
                              ...
                              child: PopupMenuButton(
                                  ...
                                  itemBuilder: (
                                      context) => //Currently needs to be moved, so the list doesn't spawn under the finger that pushes the button.
                                  [
                                    PopupMenuItem(
