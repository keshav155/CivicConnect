...
class UserHistoryPostScreen extends StatelessWidget {
  static const String id = 'HistoryPost_Screen';
  final QueryDocumentSnapshot dataPassed;
  const UserHistoryPostScreen({Key key, @required this.dataPassed})
      : super(key: key);
//  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Align(
                  alignment: Alignment.centerLeft,
                  child: Flexible(child: Text('You voted yes.')),
                ),
              ),
            ),
            Container(
